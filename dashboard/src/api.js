...
export const api = {
  ...
  relatorio: {
    ...
    moveTopic:    (id, store_name)             => request('PATCH',  `/api/relatorio/topics/${id}/move`, { store_name }),
    replicateTopic: (id, target_stores)        => request('POST',   `/api/relatorio/topics/${id}/replicate`, { target_stores }),
